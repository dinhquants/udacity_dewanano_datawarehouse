...
def create_iam_role(iam):
    ...
    try:
        ...
        print('exit try create_iam_role')
...
def get_iam_role(iam):
    """ Get IAM role for Redshift cluster """
...
def create_redshift_cluster(redshift, role_arn):
    ...
    logging.info('Enter to create_redshift_cluster')
    try:
...
def open_tcp(ec2, vpc_id):
    ...
    try:
        logging.info('vpc_id {}'.format(vpc_id))
